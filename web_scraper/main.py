...
def merge_stations():
    current_mrt_hdb = pd.read_csv('Data/Flat_amenities/hdb_stations_current.csv')
    new_mrt_hdb = pd.read_csv('Data/Flat_amenities/hdb_stations_new.csv')
...
def merge_amenities():
    ...
    school_hdb = pd.read_csv('Data/Flat_amenities/hdb_top_schools.csv')
    hawker_hdb = pd.read_csv('Data/Flat_amenities/hdb_hawker.csv')
    station_hdb = pd.read_csv('Data/Flat_amenities/hdb_final_stations.csv')
