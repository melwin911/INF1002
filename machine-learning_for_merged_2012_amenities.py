...
df = pd.read_csv("merged_2012_amenities.csv")

# Label Encode produces better correlation
# labelEncoder = LabelEncoder()
# df["town"] = labelEncoder.fit_transform(df["town"])
# df["flat"] = labelEncoder.fit_transform(df["flat"])
# df["park"] = labelEncoder.fit_transform(df["park"])
# df["mall"] = labelEncoder.fit_transform(df["mall"])
# df["top_school"] = labelEncoder.fit_transform(df["top_school"])
# df["hawker"] = labelEncoder.fit_transform(df["hawker"])
# df["station_name"] = labelEncoder.fit_transform(df["station_name"])
# df["station_name_2027_onwards"] = labelEncoder.fit_transform(df["station_name_2027_onwards"])
...
# merged_2012_le_df = 'merged_2012_le_df.csv'
# df.to_csv(merged_2012_le_df, index=False)
# print('Encoded CSV file saved at:', merged_2012_le_df)

df = pd.read_csv("merged_2012_le_df.csv")
...
# Not dropping any columns as models perform better with max columns in ths case
...
# Performances
# 1st Iteration KNN RMSE: 56140.315318
# 1st Iteration MLR RMSE: 92095.392771
# 1st Iteration XGB RMSE: 51421.354217
# 1st Iteration LSO RMSE: 92096.369046
# 1st Iteration RDG RMSE: 92095.401424
# ===
# 2nd Iteration KNN RMSE: 60379.099040
# 2nd Iteration MLR RMSE: 92095.392771
# 2nd Iteration XGB RMSE: 50837.406689
# 2nd Iteration LSO RMSE: 92096.369046
# 2nd Iteration RDG RMSE: 140660.790619